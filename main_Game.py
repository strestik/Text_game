...
Enemy = en_classing(Enemy, f"{random.choice(characters)}")  
...
Hero_name = nameing(Hero)
Hero = Character(f"{Hero_name}", f"")  # Initialize Hero character
print("\n--> Hmm", end='', flush=True)
for _ in range(4):
    time.sleep(0.3)
...
Hero = Character(f"{Hero_name}", f"{classing(Hero)}") 
print(Hero)
time.sleep(2)
